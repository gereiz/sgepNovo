    ...
    <table class="w-full mt-6 border-collapse">
        ...
        <tbody class="w-full">
             <tr class="w-full flex text-sm text-gray-800 ">
                ...
                <td class="w-[8%] ps-2 border-2 border-l-0 border-t-0 font-bold text-xs">Parcela</td>
                <td class="w-[9%] ps-2 border-2 border-l-0 border-t-0 font-bold text-xs">Vlr Parcela</td>
            </tr>
            ...
            @foreach ($servicos as $serv)
                <tr class="w-full flex text-sm text-gray-800">
                    ...
                    <td class="w-[8%] ps-2 border-2 border-l-0 border-t-0 font-light text-xs">{{isset($serv['lancamento']) ? $serv['lancamento']->parcelas : ''}}</td>
                    <td class="w-[9%] ps-2 border-2 border-l-0 border-t-0 font-light text-xs">{{isset($serv['lancamento']) ? formataCash($serv['lancamento']->valor) : ''}}</td>
                </tr>
            @endforeach
