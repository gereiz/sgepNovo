...
<template>
    ...
    <div class="modal flex items-end md:items-center">
        <div class="modal-box w-full max-h-[90vh] flex flex-col mt-14">
            ...
            <div class="w-full max-h-[80vh] flex-col flex justify-center mt-8 overflow-y-auto">
                ...
                <div class="mt-5 sm:my-4 sm:flex sm:flex-row-reverse">
