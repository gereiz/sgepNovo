...
const emit = defineEmits(['closeAcessos', 'sendFormUsu'])
const toastr = useToastr()




function closeAcessos(val){
...
<template>
    <div class="w-full flex flex-col items-center justify-center space-y-8">
        ...
        <div class="mt-5 sm:mt-6 w-full space-y-4 border-t border-gray-200 pt-4 sm:space-x-8">
            ...
            <label class="mt-3 inline-flex w-10/12 justify-center rounded-md bg-gray-200 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-5/12" @click="closeAcessos('f')">Cancelar</label>
        </div>
