...
const emit = defineEmits(['nextStep','formFour']);
...
const nextStep = (val) => {
    ...
    if(val == 5) {
        ...
        if(formFour.pgto == 0) {
            Swal.fire({
                title: 'Atenção',
                html: 'Você está realizando uma venda sem pagamento. Deseja continuar?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    formFour.servicos = servicosPagos.value
...
<template>
    <div class="space-y-6">
        <div class="mt-3 text-center sm:mt-0 sm:text-left">
            <h1 as="h3" class="text-base font-semibold leading-6 text-gray-900">Dados Financeiros</h1>
            <div class="flex mt-2">
                <p class="text-sm text-gray-500 mb-4">Confira os dados financeiros da venda.</p>
        ...
        <div :class="{'hidden': servicosPagos.length == 0}" class="w-full max-h-40 flex flex-col overflow-auto">
            <div v-for="(sp, index) in servicosPagos" :key="sp.id" class="w-full flex flex-wrap space-y-4 sm:space-y-0 justify-between">
                <div class="w-10/12 md:w-[30%]">
                    <label class="label">
                        <span class="label-text">Serviço</span>
                    </label>
                    <input type="text"
        ...
        <div class="flex flex-wrap space-x-0 sm:space-x-6 space-y-4 sm:space-y-0">
            ...
            <div class="w-10/12 sm:w-[30%]">
                <label class="label">
                    <span class="label-text">Qtd Parcelas</span>
                </label>
