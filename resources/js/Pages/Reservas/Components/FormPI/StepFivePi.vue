...
<template>
  <div class="space-y-6">
    <div>
      <h2 class="text-base font-semibold">Observações da Reserva</h2>
      <p class="text-sm text-base-content/70">Inclua informações complementares que devem constar na reserva.</p>
    </div>
