...
import { defineComponent, getCurrentInstance, watch, watchEffect, reactive, onUnmounted, ref, isRef, createTextVNode, resolveComponent, h, provide, inject, onMounted, computed, toRef, onBeforeUnmount, markRaw, nextTick, triggerRef, isReactive } from 'vue';
 ...
 * @public
 */
const FormKitRoot = defineComponent((_p, context) => {
...
export { FormKit, FormKitIcon, FormKitMessages, FormKitRoot, FormKitSchema, vueBindings as bindings, configSymbol, createInput, defaultConfig, defineFormKitConfig, getCurrentSchemaNode, onSSRComplete, optionsSymbol, parentSymbol, plugin, rootSymbol, ssrComplete, useInput };
