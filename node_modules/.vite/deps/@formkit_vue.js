...
// node_modules/@formkit/vue/node_modules/@formkit/themes/dist/index.mjs
...
function useInput(props2, context, options = {}) {
  ...
  const isVModeled = ["modelValue", "model-value"].some((prop) => {
    var _a;
    return prop in ((_a = instance === null || instance === void 0 ? void 0 : instance.vnode.props) !== null && _a !== void 0 ? _a : {});
  });
  let isMounted = false;
  onMounted(() => {
    isMounted = true;
