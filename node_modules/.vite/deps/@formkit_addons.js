...
function createSSRStepsFromTabs(tabs2) {
  ...
  const placeholderTabs = tabs2.map((tab2, index) => {
    ...
    return {
      ...
      stepName: ((_a = tab2.props) === null || _a === void 0 ? void 0 : _a.label) || camel2title((_b = tab2.props) === null || _b === void 0 ? void 0 : _b.name),
      isFirstStep: index === 0,
      isLastStep: index === tabs2.length - 1,
      isActiveStep: index === 0,
      node: {
        name: (_c = tab2.props) === null || _c === void 0 ? void 0 : _c.name
      }
    };
  });
      ...
      node.on("prop:activeStep", ({ payload }) => {
        node.children.forEach((child) => {
          ...
          if (isBrowser && child.name === payload) {
            const el = (_a2 = node.props.__root) === null || _a2 === void 0 ? void 0 : _a2.querySelector(`[aria-controls="${child.props.id}"]`);
