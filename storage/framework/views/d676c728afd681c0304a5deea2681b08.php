<table class="table" style="border-collapse: collapse; width: 100%;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border: 1px solid #cfcfcf; font-size: 11px; padding: 2px 4px;"><?php echo e(formataCash(($serv['vlr_unit'] ?? 0) * $qtd_cobrada)); ?></td>
            <td style="border: 1px solid #cfcfcf; font-size: 11px; padding: 2px 4px;"><?php echo e(formataCash(($serv['vlr_desc'] ?? 0) * $qtd_cobrada)); ?></td>
            <td style="border: 1px solid #cfcfcf; font-size: 11px; padding: 2px 4px;"><?php echo e(formataCash((($serv['vlr_unit'] ?? 0) - ($serv['vlr_desc'] ?? 0)) * $qtd_cobrada)); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
</table>
<?php /**PATH C:\laragon\www\sgepNovo\resources\views/relatorios/pi/components/descricao_servico.blade.php ENDPATH**/ ?>