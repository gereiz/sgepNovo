...
<table class="table table-bordered mb-4" style="border: 1px solid #666666;">
    <tr style="border: 1px solid #666666;">
        <td class="align-middle" style="width: 20%; border: 1px solid #666666;">
            <img src="<?php echo e(public_path('storage/img/logo.png')); ?>" alt="Logo" style="width: 150px;">
        </td>
        <td class="text-center align-middle" style="width: 60%; border: 1px solid #666666; padding: 5px;">
            ...
            <p class="title" style="margin: 5px 0 0 0;"><?php echo e($titulo); ?></p>
            <p style="margin: 0; text-align: right; margin-right: 24px; font-size: 14px;"><?php if(isset($via)): ?><b> Via: <?php echo e($via); ?></b> - <?php endif; ?>  Emissão: <?php echo e($dt_atual); ?></p>
        </td>
...
<?php /**PATH C:\laragon\www\sgepNovo\resources\views/relatorios/includes/rel_header.blade.php ENDPATH**/ ?>