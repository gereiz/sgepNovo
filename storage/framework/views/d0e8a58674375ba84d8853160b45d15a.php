...
<?php if(isset($lista_lancamentos) && count($lista_lancamentos) > 0): ?>
    <table class="table" style="border-collapse: collapse; width: 100%; margin-top: -10px; border: 1px solid #cfcfcf;">
        <tbody>
                    ...
                    <?php for($j = 0; $j < $colunas; $j++): ?>
                        ...
                        <?php if($index < $totalParcelas): ?>
                            <td colspan="3" style="border: 1px solid #cfcfcf; font-size: 11px; padding: 2px 4px;">
                                ...
                                ?>
                                Parcela <?php echo e($lista_lancamentos[$index]['parcelas']); ?> => <?php echo e(formataCash($valorParcelaCliente)); ?> - Venc: <?php echo e(formataData($lista_lancamentos[$index]['data_lancamento'])); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sgepNovo\resources\views/relatorios/pi/components/totais.blade.php ENDPATH**/ ?>