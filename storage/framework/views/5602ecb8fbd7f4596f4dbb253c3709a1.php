...
<?php echo $__env->make('relatorios.includes.rel_header', ['titulo' => 'PEDIDO DE INSERÇÃO', 'doc' => 'PI', 'num' => $num, 'via' => 'Cliente'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('relatorios.pi.components.descricao_servico', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->make('relatorios.pi.components.totais', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\laragon\www\sgepNovo\resources\views/relatorios/pi/pi_nova.blade.php ENDPATH**/ ?>